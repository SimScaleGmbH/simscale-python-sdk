...
class InactiveAdjustableTimestep(object):
    ...
    def __init__(self, type='INACTIVE_TIMESTEP', local_vars_configuration=None):  # noqa: E501
        """InactiveAdjustableTimestep - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InactiveAdjustableTimestep):
            return False
