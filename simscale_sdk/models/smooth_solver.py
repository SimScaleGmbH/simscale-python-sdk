...
class SmoothSolver(object):
    ...
    def __init__(self, type='SMOOTH', absolute_tolerance=None, relative_tolerance=None, smoother=None, num_sweeps=None, local_vars_configuration=None):  # noqa: E501
        """SmoothSolver - a model defined in OpenAPI"""  # noqa: E501
    ...
    def type(self):
        ...
        :return: The type of this SmoothSolver.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SmoothSolver.


        :param type: The type of this SmoothSolver.  # noqa: E501
        :type: str
        """
    ...
    def absolute_tolerance(self):
        ...
        :return: The absolute_tolerance of this SmoothSolver.  # noqa: E501
        :rtype: float
        """
    ...
    def absolute_tolerance(self, absolute_tolerance):
        """Sets the absolute_tolerance of this SmoothSolver.

        <p>Define the absolute tolerance for the residual. The convergence process will be stopped as soon as the residual falls below the absolute tolerance.</p>  # noqa: E501

        :param absolute_tolerance: The absolute_tolerance of this SmoothSolver.  # noqa: E501
        :type: float
        """
    ...
    def relative_tolerance(self):
        ...
        :return: The relative_tolerance of this SmoothSolver.  # noqa: E501
        :rtype: float
        """
    ...
    def relative_tolerance(self, relative_tolerance):
        """Sets the relative_tolerance of this SmoothSolver.

        <p>Choose the relative tolerance for the residual. The convergence process will be stopped as soon as the ratio of current to initial residual falls below the relative tolerance.</p>  # noqa: E501

        :param relative_tolerance: The relative_tolerance of this SmoothSolver.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def smoother(self):
        ...
        :return: The smoother of this SmoothSolver.  # noqa: E501
        :rtype: str
        """
    ...
    def smoother(self, smoother):
        """Sets the smoother of this SmoothSolver.

        <p>Choose a smoother for your solver.</p>  # noqa: E501

        :param smoother: The smoother of this SmoothSolver.  # noqa: E501
        :type: str
        """
    ...
    def num_sweeps(self):
        ...
        :return: The num_sweeps of this SmoothSolver.  # noqa: E501
        :rtype: int
        """
    ...
    def num_sweeps(self, num_sweeps):
        """Sets the num_sweeps of this SmoothSolver.

        <p>Define the numbers of sweeps.</p>  # noqa: E501

        :param num_sweeps: The num_sweeps of this SmoothSolver.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SmoothSolver):
            return False
