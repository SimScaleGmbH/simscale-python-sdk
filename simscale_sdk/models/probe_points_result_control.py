...
class ProbePointsResultControl(object):
    ...
    openapi_types = {
        'type': 'str',
        'name': 'str',
        'write_control': 'OneOfProbePointsResultControlWriteControl',
        'fraction_from_end': 'float',
        'export_statistics': 'bool',
        'geometry_primitive_uuids': 'list[str]',
        'probe_locations': 'TableDefinedProbeLocations'
    }
    ...
    attribute_map = {
        ...
        'probe_locations': 'probeLocations'
    }

    def __init__(self, type='PROBE_POINTS', name=None, write_control=None, fraction_from_end=None, export_statistics=None, geometry_primitive_uuids=None, probe_locations=None, local_vars_configuration=None):  # noqa: E501
        """ProbePointsResultControl - a model defined in OpenAPI"""  # noqa: E501
        ...
        if probe_locations is not None:
    ...
    def name(self):
        ...
        :return: The name of this ProbePointsResultControl.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProbePointsResultControl.


        :param name: The name of this ProbePointsResultControl.  # noqa: E501
        :type: str
        """
    ...
    def write_control(self):
        ...
        :return: The write_control of this ProbePointsResultControl.  # noqa: E501
        :rtype: OneOfProbePointsResultControlWriteControl
        """
        return self._write_control

    @write_control.setter
    def write_control(self, write_control):
        """Sets the write_control of this ProbePointsResultControl.


        :param write_control: The write_control of this ProbePointsResultControl.  # noqa: E501
        :type: OneOfProbePointsResultControlWriteControl
        """
    ...
    def fraction_from_end(self):
        ...
        :return: The fraction_from_end of this ProbePointsResultControl.  # noqa: E501
        :rtype: float
        """
    ...
    def fraction_from_end(self, fraction_from_end):
        """Sets the fraction_from_end of this ProbePointsResultControl.

        It defines the point in simulation where the result output data extraction starts. For instance, <i>Fraction from end</i> of 1 (100%) extracts all data from the beginning of the simulation while default 0.2 extracts 20% data from the end of the simulation.  # noqa: E501

        :param fraction_from_end: The fraction_from_end of this ProbePointsResultControl.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def geometry_primitive_uuids(self):
        ...
        :return: The geometry_primitive_uuids of this ProbePointsResultControl.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def geometry_primitive_uuids(self, geometry_primitive_uuids):
        """Sets the geometry_primitive_uuids of this ProbePointsResultControl.


        :param geometry_primitive_uuids: The geometry_primitive_uuids of this ProbePointsResultControl.  # noqa: E501
        :type: list[str]
        """
    ...
    def probe_locations(self):
        ...
        :return: The probe_locations of this ProbePointsResultControl.  # noqa: E501
        :rtype: TableDefinedProbeLocations
        """
        return self._probe_locations

    @probe_locations.setter
    def probe_locations(self, probe_locations):
        """Sets the probe_locations of this ProbePointsResultControl.


        :param probe_locations: The probe_locations of this ProbePointsResultControl.  # noqa: E501
        :type: TableDefinedProbeLocations
        """

        self._probe_locations = probe_locations
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProbePointsResultControl):
            return False
