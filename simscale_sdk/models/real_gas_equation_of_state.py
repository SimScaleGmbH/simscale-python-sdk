...
class RealGasEquationOfState(object):
    ...
    def __init__(self, type='REAL_GAS', density=None, specific_enthalpy=None, local_vars_configuration=None):  # noqa: E501
        """RealGasEquationOfState - a model defined in OpenAPI"""  # noqa: E501
    ...
    def type(self):
        ...
        :return: The type of this RealGasEquationOfState.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this RealGasEquationOfState.

        <br><p>The <b>Equation of state</b> describes the relation between density of a fluid and the fluid pressure and temperature. The available options are:</p><p><b>Rho const:</b> Fluid density is assumed constant.</p><p><b>Incompressibel perfect gas:</b> The fluid is assumed to be an 'Ideal Gas' that is incompressible by pressure. But, fluid density can change due to temperature.</p><p><b>Perfect gas:</b> Fluid is assumed to be an 'Ideal Gas' and obeys the 'Ideal Gas Law'.</p><p><b>Perfect fluid:</b> Fluid density can change due to pressure and temperature with respect to a base value.</p><p><b>Adiabatic perfect fluid:</b> The fluid is a perfect fluid which is adiabatic in nature.</p> <a href='https://www.simscale.com/docs/simulation-setup/materials/thermophysical-fluid-models/#equation-of-state' target='_blank'>Learn more</a>.  Schema name: RealGasEquationOfState  # noqa: E501

        :param type: The type of this RealGasEquationOfState.  # noqa: E501
        :type: str
        """
    ...
    def density(self):
        ...
        :return: The density of this RealGasEquationOfState.  # noqa: E501
    ...
    def density(self, density):
        """Sets the density of this RealGasEquationOfState.


        :param density: The density of this RealGasEquationOfState.  # noqa: E501
    ...
    def specific_enthalpy(self):
        ...
        :return: The specific_enthalpy of this RealGasEquationOfState.  # noqa: E501
    ...
    def specific_enthalpy(self, specific_enthalpy):
        """Sets the specific_enthalpy of this RealGasEquationOfState.


        :param specific_enthalpy: The specific_enthalpy of this RealGasEquationOfState.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RealGasEquationOfState):
            return False
