...
class GAMGSolver(object):
    ...
    def type(self):
        ...
        :return: The type of this GAMGSolver.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this GAMGSolver.


        :param type: The type of this GAMGSolver.  # noqa: E501
        :type: str
        """
    ...
    def absolute_tolerance(self):
        ...
        :return: The absolute_tolerance of this GAMGSolver.  # noqa: E501
        :rtype: float
        """
    ...
    def absolute_tolerance(self, absolute_tolerance):
        """Sets the absolute_tolerance of this GAMGSolver.

        <p>Define the absolute tolerance for the residual. The convergence process will be stopped as soon as the residual falls below the absolute tolerance.</p>  # noqa: E501

        :param absolute_tolerance: The absolute_tolerance of this GAMGSolver.  # noqa: E501
        :type: float
        """
    ...
    def relative_tolerance(self):
        ...
        :return: The relative_tolerance of this GAMGSolver.  # noqa: E501
        :rtype: float
        """
    ...
    def relative_tolerance(self, relative_tolerance):
        """Sets the relative_tolerance of this GAMGSolver.

        <p>Choose the relative tolerance for the residual. The convergence process will be stopped as soon as the ratio of current to initial residual falls below the relative tolerance.</p>  # noqa: E501

        :param relative_tolerance: The relative_tolerance of this GAMGSolver.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def smoother(self):
        ...
        :return: The smoother of this GAMGSolver.  # noqa: E501
        :rtype: str
        """
    ...
    def smoother(self, smoother):
        """Sets the smoother of this GAMGSolver.
    ...
    def num_pre_sweeps(self):
        ...
        :return: The num_pre_sweeps of this GAMGSolver.  # noqa: E501
        :rtype: int
        """
    ...
    def num_pre_sweeps(self, num_pre_sweeps):
        """Sets the num_pre_sweeps of this GAMGSolver.


        :param num_pre_sweeps: The num_pre_sweeps of this GAMGSolver.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def num_post_sweeps(self):
        ...
        :return: The num_post_sweeps of this GAMGSolver.  # noqa: E501
        :rtype: int
        """
    ...
    def num_post_sweeps(self, num_post_sweeps):
        """Sets the num_post_sweeps of this GAMGSolver.


        :param num_post_sweeps: The num_post_sweeps of this GAMGSolver.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def cache_agglomeration_on(self):
        ...
        :return: The cache_agglomeration_on of this GAMGSolver.  # noqa: E501
        :rtype: bool
        """
    ...
    def cache_agglomeration_on(self, cache_agglomeration_on):
        """Sets the cache_agglomeration_on of this GAMGSolver.
    ...
    def num_cells_coarsest_level(self):
        ...
        :return: The num_cells_coarsest_level of this GAMGSolver.  # noqa: E501
        :rtype: int
        """
    ...
    def num_cells_coarsest_level(self, num_cells_coarsest_level):
        """Sets the num_cells_coarsest_level of this GAMGSolver.


        :param num_cells_coarsest_level: The num_cells_coarsest_level of this GAMGSolver.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def num_merge_levels(self):
        ...
        :return: The num_merge_levels of this GAMGSolver.  # noqa: E501
        :rtype: int
        """
    ...
    def num_merge_levels(self, num_merge_levels):
        """Sets the num_merge_levels of this GAMGSolver.


        :param num_merge_levels: The num_merge_levels of this GAMGSolver.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GAMGSolver):
            return False
