...
class AiUserModel(object):
    ...
    def analysis_type(self, analysis_type):
        ...
        :type: str
        """
        allowed_values = ["STATIC_ANALYSIS", "INCOMPRESSIBLE", "COUPLED_CONJUGATE_HEAT_TRANSFER", "EMBEDDED_BOUNDARY"]  # noqa: E501
    ...
    def predictor_component(self, predictor_component):
        ...
        :type: str
        """
        allowed_values = ["navasto", "ai-solver-kickstart"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and predictor_component not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `predictor_component` ({0}), must be one of {1}"  # noqa: E501
                .format(predictor_component, allowed_values)
            )
    ...
    def template_name(self, template_name):
        ...
        :type: str
        """
        allowed_values = ["fea_template", "cfd_template", "chtv2ibm_template", "spec_id", "spec_and_tesselation"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and template_name not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `template_name` ({0}), must be one of {1}"  # noqa: E501
                .format(template_name, allowed_values)
            )
