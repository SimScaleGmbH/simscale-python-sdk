...
class OneOfFanBCRadiativeIntensityRay(object):
    ...
    def __init__(self, type='SEMI_OPEN_BOUNDARY_RAY', emissivity=None, farfield_black_body_temperature=None, transmissivity=None, local_vars_configuration=None):  # noqa: E501
        """OneOfFanBCRadiativeIntensityRay - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
        ...
        :return: The type of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OneOfFanBCRadiativeIntensityRay.

        <p><b>Radiative behaviour of the wall</b>. The Kirchhoff's law of thermal radiation is applied in all options. This means that the <b>absorptivity of the surface is equal to its emissivity</b>. <br> <ul><li><b>Opaque</b> is applied to surfaces with transmissivity equal to 0. The radiation that hits the surface will be absorbed and reflected, but not transmitted, e.g.: brick or concrete walls.</li><li><b>Transparent</b> is applied to surfaces with transmissivity equal to 1. The radiation that hits the surface will be fully transmitted to the other side, e.g.: inlets, outlets or regular windows.</li><li><b>Semi-transparent</b> is applied to non-fully transparent surfaces. The radiation that hits the surface will be absorbed, reflected and transmitted, e.g. some stained glass windows.</li></ul></p>  Schema name: SemiOpenBoundaryRayBC  # noqa: E501

        :param type: The type of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
        :type: str
        """
    ...
    @property
    def emissivity(self):
        """Gets the emissivity of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501


        :return: The emissivity of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
        :rtype: float
        """
    ...
    def emissivity(self, emissivity):
        """Sets the emissivity of this OneOfFanBCRadiativeIntensityRay.


        :param emissivity: The emissivity of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
        :type: float
        """
    ...
    def farfield_black_body_temperature(self):
        """Gets the farfield_black_body_temperature of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501


        :return: The farfield_black_body_temperature of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
    ...
    def farfield_black_body_temperature(self, farfield_black_body_temperature):
        """Sets the farfield_black_body_temperature of this OneOfFanBCRadiativeIntensityRay.


        :param farfield_black_body_temperature: The farfield_black_body_temperature of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
    ...
    def transmissivity(self):
        """Gets the transmissivity of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501


        :return: The transmissivity of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
        :rtype: float
        """
    ...
    def transmissivity(self, transmissivity):
        """Sets the transmissivity of this OneOfFanBCRadiativeIntensityRay.


        :param transmissivity: The transmissivity of this OneOfFanBCRadiativeIntensityRay.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfFanBCRadiativeIntensityRay):
            return False
