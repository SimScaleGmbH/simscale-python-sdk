...
class MeshOperation(object):
    ...
    def __init__(self, mesh_operation_id=None, name=None, version='7.0', geometry_id=None, model=None, created_at=None, modified_at=None, started_at=None, finished_at=None, compute_resource=None, status=None, progress=None, mesh_id=None, local_vars_configuration=None):  # noqa: E501
