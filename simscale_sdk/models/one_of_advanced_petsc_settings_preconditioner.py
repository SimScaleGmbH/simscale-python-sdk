...
class OneOfAdvancedPETSCSettingsPreconditioner(object):
    ...
    def __init__(self, type='INACTIVE', actualisation_rate=None, memory_percentage_for_pivoting=None, matrix_completeness=None, preconditioner_matrix_growth=None, renumbering_method=None, local_vars_configuration=None):  # noqa: E501
        """OneOfAdvancedPETSCSettingsPreconditioner - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501

        Schema name: InactivePreconditioner  # noqa: E501

        :return: The type of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OneOfAdvancedPETSCSettingsPreconditioner.

        Schema name: InactivePreconditioner  # noqa: E501

        :param type: The type of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :type: str
        """
    ...
    def actualisation_rate(self):
        """Gets the actualisation_rate of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        ...
        :return: The actualisation_rate of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :rtype: int
        """
    ...
    def actualisation_rate(self, actualisation_rate):
        """Sets the actualisation_rate of this OneOfAdvancedPETSCSettingsPreconditioner.

        Set the reactualisation intervall for the preconditioner matrix P. If this value is set to 30 the preconditioner is recomputed just every 30th iteration. This preconditioner is computionally more expensive than the incomplete LDLT factorization but nearer to the exact solution. This setting makes it possible to save computation time by taking advantage of this fact.  # noqa: E501

        :param actualisation_rate: The actualisation_rate of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :type: int
        """
    ...
    def memory_percentage_for_pivoting(self):
        """Gets the memory_percentage_for_pivoting of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        ...
        :return: The memory_percentage_for_pivoting of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :rtype: float
        """
    ...
    def memory_percentage_for_pivoting(self, memory_percentage_for_pivoting):
        """Sets the memory_percentage_for_pivoting of this OneOfAdvancedPETSCSettingsPreconditioner.

        Define how much additional memory should be reserved for the pivoting operations. If MUMPS estimates that the necessary space for factorising the matrix would be 100, choosing a value of 20 would mean that MUMPS allocates a memory space of 120.  # noqa: E501

        :param memory_percentage_for_pivoting: The memory_percentage_for_pivoting of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :type: float
        """
    ...
    def matrix_completeness(self):
        """Gets the matrix_completeness of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        ...
        :return: The matrix_completeness of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :rtype: int
        """
    ...
    def matrix_completeness(self, matrix_completeness):
        """Sets the matrix_completeness of this OneOfAdvancedPETSCSettingsPreconditioner.

        Set the level of completeness for the incomplete Cholesky decomposition. The larger this value is, the better the preconditioning Matrix P approximates K<sup>-1</sup>, but also the memory usage and computation time increase. If the solution does not converge or uses a lot of iterations it could help to increase this parameter.  # noqa: E501

        :param matrix_completeness: The matrix_completeness of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :type: int
        """
    ...
    def preconditioner_matrix_growth(self):
        """Gets the preconditioner_matrix_growth of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        ...
        :return: The preconditioner_matrix_growth of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :rtype: float
        """
    ...
    def preconditioner_matrix_growth(self, preconditioner_matrix_growth):
        """Sets the preconditioner_matrix_growth of this OneOfAdvancedPETSCSettingsPreconditioner.

        Set the growth rate of the filling for the incomplete decomposition matrix. If this parameter is set to 1.0 PETSc estimates the matrix storage size from the first level of completeness. If this estimate is too low, PETSC increases the allocated memory on the fly, but this is more expensive.  # noqa: E501

        :param preconditioner_matrix_growth: The preconditioner_matrix_growth of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :type: float
        """
    ...
    def renumbering_method(self):
        """Gets the renumbering_method of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        ...
        :return: The renumbering_method of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :rtype: str
        """
    ...
    def renumbering_method(self, renumbering_method):
        """Sets the renumbering_method of this OneOfAdvancedPETSCSettingsPreconditioner.

        Choose the renumbering method for the system matrix entries:<ul><li><p><b>RCMK</b> uses the algorithm of <i>Reverse Cuthill-MacKee</i> for the renumbering. It often effectively reduces the matrig storage space and the matrix factorization time.</p></ul><ul><li><p>When <b>inactive</b> is selected no renumbering is done. This option should only be chosen for testing purposes.</p></ul>  # noqa: E501

        :param renumbering_method: The renumbering_method of this OneOfAdvancedPETSCSettingsPreconditioner.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfAdvancedPETSCSettingsPreconditioner):
            return False
