...
class OneOfFluidSolversNuTildaFinalSolver(object):
    ...
    def __init__(self, type='SMOOTH', absolute_tolerance=None, relative_tolerance=None, preconditioner=None, smoother=None, num_sweeps=None, local_vars_configuration=None):  # noqa: E501
        """OneOfFluidSolversNuTildaFinalSolver - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501

        Schema name: SmoothSolver  # noqa: E501

        :return: The type of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OneOfFluidSolversNuTildaFinalSolver.

        Schema name: SmoothSolver  # noqa: E501

        :param type: The type of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :type: str
        """
    ...
    def absolute_tolerance(self):
        """Gets the absolute_tolerance of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        ...
        :return: The absolute_tolerance of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :rtype: float
        """
    ...
    def absolute_tolerance(self, absolute_tolerance):
        """Sets the absolute_tolerance of this OneOfFluidSolversNuTildaFinalSolver.

        <p>Define the absolute tolerance for the residual. The convergence process will be stopped as soon as the residual falls below the absolute tolerance.</p>  # noqa: E501

        :param absolute_tolerance: The absolute_tolerance of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :type: float
        """
    ...
    def relative_tolerance(self):
        """Gets the relative_tolerance of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        ...
        :return: The relative_tolerance of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :rtype: float
        """
    ...
    def relative_tolerance(self, relative_tolerance):
        """Sets the relative_tolerance of this OneOfFluidSolversNuTildaFinalSolver.

        <p>Choose the relative tolerance for the residual. The convergence process will be stopped as soon as the ratio of current to initial residual falls below the relative tolerance.</p>  # noqa: E501

        :param relative_tolerance: The relative_tolerance of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def preconditioner(self):
        """Gets the preconditioner of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501


        :return: The preconditioner of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
    ...
    def preconditioner(self, preconditioner):
        """Sets the preconditioner of this OneOfFluidSolversNuTildaFinalSolver.


        :param preconditioner: The preconditioner of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
    ...
    @property
    def smoother(self):
        """Gets the smoother of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501

        <p>Choose a smoother for your solver.</p>  # noqa: E501

        :return: The smoother of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :rtype: str
        """
    ...
    def smoother(self, smoother):
        """Sets the smoother of this OneOfFluidSolversNuTildaFinalSolver.

        <p>Choose a smoother for your solver.</p>  # noqa: E501

        :param smoother: The smoother of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :type: str
        """
    ...
    @property
    def num_sweeps(self):
        """Gets the num_sweeps of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501

        <p>Define the numbers of sweeps.</p>  # noqa: E501

        :return: The num_sweeps of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :rtype: int
        """
    ...
    def num_sweeps(self, num_sweeps):
        """Sets the num_sweeps of this OneOfFluidSolversNuTildaFinalSolver.

        <p>Define the numbers of sweeps.</p>  # noqa: E501

        :param num_sweeps: The num_sweeps of this OneOfFluidSolversNuTildaFinalSolver.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfFluidSolversNuTildaFinalSolver):
            return False
