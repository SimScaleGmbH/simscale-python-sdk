...
class AutomaticMeshSizing(object):
    ...
    def type(self):
        ...
        :return: The type of this AutomaticMeshSizing.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this AutomaticMeshSizing.


        :param type: The type of this AutomaticMeshSizing.  # noqa: E501
        :type: str
        """
    ...
    def fineness(self):
        ...
        :return: The fineness of this AutomaticMeshSizing.  # noqa: E501
        :rtype: str
        """
    ...
    def fineness(self, fineness):
        """Sets the fineness of this AutomaticMeshSizing.

        <p>This parameter determines the <b>fineness of the mesh</b> and affects the overall number of cells. It is recommended to start with the <i>coarse</i> setting. <a href='https://www.simscale.com/docs/simulation-setup/meshing/tet-dominant/#sizing' target='_blank'>Find out more.</a></p><p><b>Note:</b> This setting will impact the accuracy of your results as well as computing time and result size. A finer mesh will be more demanding in terms of machine size and memory but lead to more accurate results in most cases.</p>  # noqa: E501

        :param fineness: The fineness of this AutomaticMeshSizing.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AutomaticMeshSizing):
            return False
