...
class OneOfDivergenceSchemesDivRhoPhiVelocity(object):
    ...
    def __init__(self, type='GAUSS_LINEARUPWINDV_GRAD_U_', local_vars_configuration=None):  # noqa: E501
        """OneOfDivergenceSchemesDivRhoPhiVelocity - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfDivergenceSchemesDivRhoPhiVelocity):
            return False
