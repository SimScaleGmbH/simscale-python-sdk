...
class OneOfGradientSchemesGradDensity(object):
    ...
    def __init__(self, type='LEASTSQUARES', limiter_coefficient=None, local_vars_configuration=None):  # noqa: E501
        """OneOfGradientSchemesGradDensity - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this OneOfGradientSchemesGradDensity.  # noqa: E501


        :return: The type of this OneOfGradientSchemesGradDensity.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OneOfGradientSchemesGradDensity.


        :param type: The type of this OneOfGradientSchemesGradDensity.  # noqa: E501
        :type: str
        """
    ...
    def limiter_coefficient(self):
        """Gets the limiter_coefficient of this OneOfGradientSchemesGradDensity.  # noqa: E501

        This property defines a limiter coefficient for the scheme. 1 ensures boundedness while 0 applies no limiting.  # noqa: E501

        :return: The limiter_coefficient of this OneOfGradientSchemesGradDensity.  # noqa: E501
        :rtype: float
        """
    ...
    def limiter_coefficient(self, limiter_coefficient):
        """Sets the limiter_coefficient of this OneOfGradientSchemesGradDensity.

        This property defines a limiter coefficient for the scheme. 1 ensures boundedness while 0 applies no limiting.  # noqa: E501

        :param limiter_coefficient: The limiter_coefficient of this OneOfGradientSchemesGradDensity.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfGradientSchemesGradDensity):
            return False
