...
class OneOfPBICGSolverPreconditioner(object):
    ...
    def __init__(self, type='ILUCP', absolute_tolerance=None, relative_tolerance=None, smoother=None, num_pre_sweeps=None, num_post_sweeps=None, cache_agglomeration_on=True, num_cells_coarsest_level=None, num_merge_levels=None, fill_in_level=None, local_vars_configuration=None):  # noqa: E501
