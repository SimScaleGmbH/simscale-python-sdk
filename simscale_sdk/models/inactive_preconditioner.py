...
class InactivePreconditioner(object):
    ...
    def __init__(self, type='INACTIVE', renumbering_method=None, local_vars_configuration=None):  # noqa: E501
        """InactivePreconditioner - a model defined in OpenAPI"""  # noqa: E501
    ...
    def type(self):
        ...
        :return: The type of this InactivePreconditioner.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this InactivePreconditioner.

        Schema name: InactivePreconditioner  # noqa: E501

        :param type: The type of this InactivePreconditioner.  # noqa: E501
        :type: str
        """
    ...
    def renumbering_method(self):
        ...
        :return: The renumbering_method of this InactivePreconditioner.  # noqa: E501
        :rtype: str
        """
    ...
    def renumbering_method(self, renumbering_method):
        """Sets the renumbering_method of this InactivePreconditioner.

        Choose the renumbering method for the system matrix entries:<ul><li><p><b>RCMK</b> uses the algorithm of <i>Reverse Cuthill-MacKee</i> for the renumbering. It often effectively reduces the matrig storage space and the matrix factorization time.</p></ul><ul><li><p>When <b>inactive</b> is selected no renumbering is done. This option should only be chosen for testing purposes.</p></ul>  # noqa: E501

        :param renumbering_method: The renumbering_method of this InactivePreconditioner.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InactivePreconditioner):
            return False
