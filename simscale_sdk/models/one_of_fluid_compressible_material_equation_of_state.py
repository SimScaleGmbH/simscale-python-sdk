...
class OneOfFluidCompressibleMaterialEquationOfState(object):
    ...
    def __init__(self, type='RHO_CONST', energy=None, density=None, density_function=None, local_vars_configuration=None):  # noqa: E501
        """OneOfFluidCompressibleMaterialEquationOfState - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
        ...
        :return: The type of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OneOfFluidCompressibleMaterialEquationOfState.

        <br><p>The <b>Equation of state</b> describes the relation between density of a fluid and the fluid pressure and temperature. The available options are:</p><p><b>Rho const:</b> Fluid density is assumed constant.</p><p><b>Incompressibel perfect gas:</b> The fluid is assumed to be an 'Ideal Gas' that is incompressible by pressure. But, fluid density can change due to temperature.</p><p><b>Perfect gas:</b> Fluid is assumed to be an 'Ideal Gas' and obeys the 'Ideal Gas Law'.</p><p><b>Perfect fluid:</b> Fluid density can change due to pressure and temperature with respect to a base value.</p><p><b>Adiabatic perfect fluid:</b> The fluid is a perfect fluid which is adiabatic in nature.</p> <a href='https://www.simscale.com/docs/simulation-setup/materials/thermophysical-fluid-models/#equation-of-state' target='_blank'>Learn more</a>.  Schema name: RhoConstEquationOfState  # noqa: E501

        :param type: The type of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
        :type: str
        """
    ...
    @property
    def energy(self):
        """Gets the energy of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
        ...
        :return: The energy of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
        :rtype: str
        """
        return self._energy
    ...
    def energy(self, energy):
        """Sets the energy of this OneOfFluidCompressibleMaterialEquationOfState.

        <p><b>Energy</b> provides the methods for the form of energy to be used. The options are:</p><p><b>Sensible enthalpy:</b> The enthalpy form of equation is used without the heat of formation. In most cases this is the recommended choice.</p><p><b>Sensible internal Energy:</b> The internal energy form of equation is used without the heat of formation but also incorporates energy change due to reactions.</p>  # noqa: E501

        :param energy: The energy of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
        :type: str
        """
    ...
    @property
    def density(self):
        """Gets the density of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501


        :return: The density of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
    ...
    def density(self, density):
        """Sets the density of this OneOfFluidCompressibleMaterialEquationOfState.


        :param density: The density of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
    ...
    def density_function(self):
        """Gets the density_function of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501


        :return: The density_function of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
    ...
    def density_function(self, density_function):
        """Sets the density_function of this OneOfFluidCompressibleMaterialEquationOfState.


        :param density_function: The density_function of this OneOfFluidCompressibleMaterialEquationOfState.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfFluidCompressibleMaterialEquationOfState):
            return False
