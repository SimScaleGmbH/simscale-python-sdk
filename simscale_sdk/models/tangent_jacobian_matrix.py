...
class TangentJacobianMatrix(object):
    ...
    def __init__(self, type='TANGENT', max_newton_iteration=None, reactualization_iteration=None, reactualization_increment=None, change_jacobian_matrix=None, local_vars_configuration=None):  # noqa: E501
        """TangentJacobianMatrix - a model defined in OpenAPI"""  # noqa: E501
    ...
    def max_newton_iteration(self):
        ...
        :return: The max_newton_iteration of this TangentJacobianMatrix.  # noqa: E501
        :rtype: int
        """
    ...
    def max_newton_iteration(self, max_newton_iteration):
        """Sets the max_newton_iteration of this TangentJacobianMatrix.
    ...
    def reactualization_iteration(self):
        ...
        :return: The reactualization_iteration of this TangentJacobianMatrix.  # noqa: E501
        :rtype: int
        """
    ...
    def reactualization_iteration(self, reactualization_iteration):
        """Sets the reactualization_iteration of this TangentJacobianMatrix.
    ...
    def reactualization_increment(self):
        ...
        :return: The reactualization_increment of this TangentJacobianMatrix.  # noqa: E501
        :rtype: int
        """
    ...
    def reactualization_increment(self, reactualization_increment):
        """Sets the reactualization_increment of this TangentJacobianMatrix.

        <p>Select how often the Jacobian matrix should be recomputed. If this parameter is set to 10, the Jacobian matrix is recomputed every 10th time step. If it is set to 0, the Jacobian matrix is never updated.</p>  # noqa: E501

        :param reactualization_increment: The reactualization_increment of this TangentJacobianMatrix.  # noqa: E501
        :type: int
        """
    ...
    def change_jacobian_matrix(self):
        ...
        :return: The change_jacobian_matrix of this TangentJacobianMatrix.  # noqa: E501
    ...
    def change_jacobian_matrix(self, change_jacobian_matrix):
        """Sets the change_jacobian_matrix of this TangentJacobianMatrix.


        :param change_jacobian_matrix: The change_jacobian_matrix of this TangentJacobianMatrix.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TangentJacobianMatrix):
            return False
