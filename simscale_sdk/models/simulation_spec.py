...
class SimulationSpec(object):
    ...
    def __init__(self, simulation_id=None, name=None, version='6.0', created_at=None, modified_at=None, geometry_id=None, mesh_id=None, model=None, parameters=None, local_vars_configuration=None):  # noqa: E501
