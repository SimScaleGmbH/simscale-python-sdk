...
class OneOfWallBCVelocity(object):
    ...
    def __init__(self, type='SLIP', value=None, turbulence_wall=None, orientation_reference=None, wall_contact_model=None, enable_surface_roughness=None, surface_roughness=None, no_slip_wall_roughness_type=None, rotation=None, local_vars_configuration=None):  # noqa: E501
