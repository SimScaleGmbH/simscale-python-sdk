...
class LimitedSurfaceNormalGradientScheme(object):
    ...
    def __init__(self, type='LIMITED', limiter_coefficient=None, local_vars_configuration=None):  # noqa: E501
        """LimitedSurfaceNormalGradientScheme - a model defined in OpenAPI"""  # noqa: E501
    ...
    def type(self):
        ...
        :return: The type of this LimitedSurfaceNormalGradientScheme.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this LimitedSurfaceNormalGradientScheme.

        Schema name: LimitedSurfaceNormalGradientScheme  # noqa: E501

        :param type: The type of this LimitedSurfaceNormalGradientScheme.  # noqa: E501
        :type: str
        """
    ...
    def limiter_coefficient(self):
        ...
        :return: The limiter_coefficient of this LimitedSurfaceNormalGradientScheme.  # noqa: E501
        :rtype: float
        """
    ...
    def limiter_coefficient(self, limiter_coefficient):
        """Sets the limiter_coefficient of this LimitedSurfaceNormalGradientScheme.

        This property defines a limiter coefficient for the scheme:<ul><li><strong>0</strong>: no correction, equivalent to the uncorrected scheme</li><li><strong>1</strong>: full non-orthogonal correction applied</li><li><strong>0.5</strong>: non-orthogonal contribution does not exceed the orthogonal part</li></ul>  # noqa: E501

        :param limiter_coefficient: The limiter_coefficient of this LimitedSurfaceNormalGradientScheme.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LimitedSurfaceNormalGradientScheme):
            return False
