...
class PlasticityMarc(object):
    ...
    def __init__(self, plasticity_model=None, local_vars_configuration=None):  # noqa: E501
        """PlasticityMarc - a model defined in OpenAPI"""  # noqa: E501
        ...
        if plasticity_model is not None:
            self.plasticity_model = plasticity_model

    @property
    def plasticity_model(self):
        """Gets the plasticity_model of this PlasticityMarc.  # noqa: E501
    ...
    def plasticity_model(self, plasticity_model):
        """Sets the plasticity_model of this PlasticityMarc.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlasticityMarc):
            return False
