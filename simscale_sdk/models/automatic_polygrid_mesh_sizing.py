...
class AutomaticPolygridMeshSizing(object):
    ...
    def __init__(self, type='AUTOMATIC_POLYGRID_MESH_SIZING', fineness=None, physics_based_meshing_ibm=None, local_vars_configuration=None):  # noqa: E501
        """AutomaticPolygridMeshSizing - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this AutomaticPolygridMeshSizing.  # noqa: E501

        Schema name: AutomaticPolygridMeshSizing  # noqa: E501

        :return: The type of this AutomaticPolygridMeshSizing.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this AutomaticPolygridMeshSizing.

        Schema name: AutomaticPolygridMeshSizing  # noqa: E501

        :param type: The type of this AutomaticPolygridMeshSizing.  # noqa: E501
        :type: str
        """
    ...
    @property
    def fineness(self):
        """Gets the fineness of this AutomaticPolygridMeshSizing.  # noqa: E501
        ...
        :return: The fineness of this AutomaticPolygridMeshSizing.  # noqa: E501
        :rtype: float
        """
    ...
    def fineness(self, fineness):
        """Sets the fineness of this AutomaticPolygridMeshSizing.

        <p>This parameter determines the <b>fineness of the mesh</b> and affects the overall number of cells.</p><p><b>Note:</b> This setting will impact the accuracy of your results as well as computing time and result size. A finer mesh will be more demanding in terms of machine size and memory but lead to more accurate results.</p>  # noqa: E501

        :param fineness: The fineness of this AutomaticPolygridMeshSizing.  # noqa: E501
        :type: float
        """
    ...
    def physics_based_meshing_ibm(self):
        """Gets the physics_based_meshing_ibm of this AutomaticPolygridMeshSizing.  # noqa: E501
        ...
        :return: The physics_based_meshing_ibm of this AutomaticPolygridMeshSizing.  # noqa: E501
        :rtype: bool
        """
    ...
    def physics_based_meshing_ibm(self, physics_based_meshing_ibm):
        """Sets the physics_based_meshing_ibm of this AutomaticPolygridMeshSizing.

        <b>Physics-based meshing</b> takes setup information into account to size the immersed mesh accordingly. Users can expect automatic refinements applied to the following: </p><ul><li><p><b>Boundary faces</b>: All of those which belong to a boundary condition.</p></li> <li><p><b>Advanced concepts</b>: Power and momentum sources, porous regions and thermal resistance networks.</p></li></ul>  # noqa: E501

        :param physics_based_meshing_ibm: The physics_based_meshing_ibm of this AutomaticPolygridMeshSizing.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AutomaticPolygridMeshSizing):
            return False
