...
class WindTunnelSizeLarge(object):
    ...
    def __init__(self, type='WIND_TUNNEL_SIZE_LARGE', local_vars_configuration=None):  # noqa: E501
        """WindTunnelSizeLarge - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WindTunnelSizeLarge):
            return False
